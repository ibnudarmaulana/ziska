                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div class="modal fade" id="exampleModal{{$item->distribusi_id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row g-3 needs-validation" action="{{url('admin/kelola-distribusi/'.$item->distribusi_id)}}" method="POST"
                                                            novalidate>
                                                            @csrf
                                                            @method('put')
                                                            <div class="col-md-6">
                                        ...
                                        <form action="{{url('admin/kelola-distribusi/'.$item->distribusi_id)}}" method="post" id="hapusdistribusi">
                                        @csrf
                                        @method('delete')
