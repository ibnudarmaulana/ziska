                                        ...
                                        <form class="row g-3 needs-validation" action="" method="POST" novalidate>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="validationTextarea"
                                                    name="alamat_muzaki" maxlength="30" required></textarea>
                                                <div class="invalid-feedback">
                                                    Mohon ketik alamat
                                                </div>
                                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row g-3 needs-validation"
                                                            action="{{url('admin/kelola-muzaki/'.$item->muzaki_id)}}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" id="validationTextarea"
                                                                    name="alamat_muzaki" maxlength="30"
                                                                    required>{{$item->alamat_muzaki}}</textarea>
                                                                <div class="invalid-feedback">
                                                                    Mohon ketik alamat
                                                                </div>
                                                            </div>
                                        ...
                                        <form action="{{url('admin/kelola-muzaki/'.$item->muzaki_id)}}" method="post"
                                            id="hapusmuzaki">
                                            @csrf
                                            @method('delete')
