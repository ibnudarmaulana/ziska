                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div class="modal fade" id="exampleModal{{$item->pemasukan_id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row g-3 needs-validation" action="{{url('upz/kelola-pemasukan/'.$item->pemasukan_id)}}" method="POST" novalidate>
                                                            @csrf
                                                            @method('put')
                                                            <div class="col-md-6">
                                                                <label for="validationServer04" class="form-label">Nama Muzaki</label>
                                        ...
                                        <form action="{{url('upz/kelola-pemasukan/'.$item->pemasukan_id)}}" method="post"
                                            id="hapuspemasukan">
                                            @csrf
                                            @method('delete')
